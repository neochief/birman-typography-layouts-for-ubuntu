...
По крайней мере некоторые дистрибутивы на базе Ubuntu по умолчанию настроены на <kbd>Right Alt</kbd>, и данная раскладка Бирмана не вводит доп. символы. Чтобы переключиться на <kbd>AltGr</kbd>, зайдите в:
